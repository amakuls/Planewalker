...
$.get("/PCSprite.json", function(data){
    ...
    Game.spritesheetinfo.player.sprite = Game.spritesheetinfo.frames["PCLeft-Idle0001.png"];
...
window.addEventListener("keydown", function(e){
    switch(e.keyCode)
    {
        ...
        case 68: // right
            ...
            Game.spritesheetinfo.player.sprite = Game.spritesheetinfo.frames["PCright0001.png"];
            break;
        case 83: // down
